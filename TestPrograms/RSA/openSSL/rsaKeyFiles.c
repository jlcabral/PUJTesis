...
#define PATH_PRIVATE_KEY    "keys/privateKey.pem"
#define PATH_PUBLIC_KEY     "keys/publicKey.pem"
...
int main(){
    ...
    char plainText[2048/8] = "Only God knows why"; //key length : 2048
...
*/ 
    ...
    int encrypted_length = public_encrypt(plainText,strlen(plainText),PATH_PUBLIC_KEY,encrypted);
    ...
    int decrypted_length = private_decrypt(encrypted,encrypted_length,PATH_PRIVATE_KEY,decrypted);
